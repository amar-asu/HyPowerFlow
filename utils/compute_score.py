...
def evaluate_model(benchmark, model, dataset_type, batch_size):
...
def compute_global_score(metrics, config):
    ...
    print("test_ood_metrics: ", test_ood_metrics)


    test_results_disc = discretize_results(test_metrics)
    test_ood_results_disc = discretize_results(test_ood_metrics)
    print("test_results_disc: ", test_results_disc)
    print("test_ood_results_disc: ", test_ood_results_disc)
    ...
    print("test_ml_subscore:", test_ml_subscore)
    print("test_physics_subscore:", test_physics_subscore)
    print("test_subscore:", test_subscore)
    ...
    print("test_ood_ml_subscore:", test_ood_ml_subscore)
    print("test_ood_physics_subscore:", test_ood_physics_subscore)
    print("test_ood_subscore:", test_ood_subscore)

    speed_up = compute_speed_up(config, metrics)
    speedup_score = SpeedMetric(speedUp=speed_up)

    print("Speed-Up Score:", speedup_score)
